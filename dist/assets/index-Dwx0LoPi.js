...
`,p=document.querySelector("#app"),s={professional:`
  ...
  `};function r(){const a=window.location.hash.slice(1)||"professional",i=s[a]||s.professional;p.innerHTML=`
    <nav>
      <a href="#professional" class="${a==="professional"?"active":""}">Professional</a>
      <a href="#music" class="${a==="music"?"active":""}">Music</a>
      <a href="#writing" class="${a==="writing"||a.startsWith("post-")?"active":""}">Writing</a>
      <a href="#about" class="${a==="about"?"active":""}">About</a>
    </nav>
